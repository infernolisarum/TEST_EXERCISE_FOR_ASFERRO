...
class GmailPage(BasePage):
    ...
    def send_letter(self, to_whom, subject_message, text_massage):
        WebDriverWait(self.driver, 10).until(
            expected.element_to_be_clickable((By.XPATH, "//div[@class='T-I J-J5-Ji T-I-KE L3']"))).click()
        ...
        self.driver.find_element(By.XPATH, "//input[@name='subjectbox']").send_keys(subject_message)
        self.driver.find_element(By.XPATH, "//div[@role='textbox']").send_keys(text_massage)
        WebDriverWait(self.driver, 10).until(expected.element_to_be_clickable((By.XPATH, "//div[@class='dC']"))).click()

    def refresh_mail(self):
        locator = (By.XPATH, "//div[@class='G-Ni J-J5-Ji']")  # TODO: change to correct name
        WebDriverWait(self.driver, 10).until(
            expected.element_to_be_clickable(locator)).click()
        WebDriverWait(self.driver, 10).until(
            expected.element_to_be_clickable(locator))  # TODO: change to 'letters.element_to_be_selected()...

    def get_all_letters(self):
        letters = self.driver.find_elements(By.XPATH, "//div/div/table/tbody/tr[@jsmodel='nXDxbd']")
        return letters
